        ...
        <div id="hot-post" class="row hot-post">
            <div class="col-md-8 hot-post-left">
                <div class="post post-thumb">
                    <a class="post-img" href="javascript:;"><img src="{{ asset('assets/website/img/hot-post-1.jpg')}}" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
                            <a href="category.html">Lifestyle</a>
                        </div>
                        <h3 class="post-title title-lg"><a href="javascript:;">Postea senserit id eos, vivendo periculis ei qui</a></h3>
                        <ul class="post-meta">
            ...
            <div class="col-md-4 hot-post-right">
                <div class="post post-thumb">
                    <a class="post-img" href="javascript:;"><img src="{{ asset('assets/website/img/hot-post-2.jpg')}}" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
                            <a href="category.html">Lifestyle</a>
                        </div>
                ...
                <div class="post post-thumb">
                    <a class="post-img" href="javascript:;"><img src="{{ asset('assets/website/img/hot-post-3.jpg')}}" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
